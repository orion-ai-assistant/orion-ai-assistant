...
class VoxCPM:
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        Args:
            ...
            vae_device: Device for the AudioVAE module (codec). Set to ``"cpu"`` 
                to save VRAM by offloading the codec to the CPU.
    ...
    def _generate(
        ...
        try:
            ...
            if normalize:
                print("Text normalization is disabled and was skipped.", file=sys.stderr)
