...
window.orionLocales.en = {
    ...
    confirm_remove_service_msg: "Are you sure you want to remove the '{0}' service?\n\n(This action permanently deletes the application files and all your database data.)",
    confirm_reinstall_service_title: "Reinstall",
    confirm_reinstall_service_msg: "Are you sure you want to reinstall the '{0}' service?\n\n(This action only resets the application files, and preserves your database and settings.)",
    confirm_wipe_data_title: "Wipe All Data",
    confirm_wipe_data_msg: "Are you sure you want to wipe all data for '{0}'?\n\n(The application is not deleted, but your chat history, database, and settings will be permanently wiped.)",
    confirm_btn_yes: "Yes",
