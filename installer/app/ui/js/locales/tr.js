...
window.orionLocales.tr = {
    ...
    confirm_remove_service_title: "Servisi Kaldır",
    confirm_remove_service_msg: "'{0}' servisini kaldırmak istediğinize emin misiniz?\n\n(Bu işlem uygulama dosyalarını ve tüm veritabanı verilerinizi kalıcı olarak siler.)",
    confirm_reinstall_service_title: "Yeniden Kur",
    confirm_reinstall_service_msg: "'{0}' servisini yeniden kurmak istediğinize emin misiniz?\n\n(Bu işlem sadece uygulama dosyalarını sıfırlar, veritabanınızı ve ayarlarınızı korur.)",
    confirm_wipe_data_title: "Tüm Verileri Sil",
    confirm_wipe_data_msg: "'{0}' için tüm verileri silmek istediğinize emin misiniz?\n\n(Uygulama silinmez, sadece veritabanı, sohbet geçmişiniz ve ayarlarınız kalıcı olarak silinir.)",
