...
window.orionLocales.tr = {
    ...
    confirm_remove_service_msg: "'{0}' servisini kaldırmak istediğinize emin misiniz? DİKKAT: Tüm verileriniz ve ayarlarınız SİLİNECEKTİR!",
    confirm_reinstall_service_title: "Yeniden Kur",
    confirm_reinstall_service_msg: "'{0}' servisini yeniden kurmak istediğinize emin misiniz? (Verileriniz ve ayarlarınız korunacaktır)",
    confirm_wipe_data_title: "Tüm Verileri Sil",
    confirm_wipe_data_msg: "UYARI: '{0}' için tüm verileri silmek istediğinize emin misiniz? Bu işlem sohbet geçmişinizi, veritabanını ve ayarlarınızı kalıcı olarak silecektir. Bu işlem geri alınamaz!",
